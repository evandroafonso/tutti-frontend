  ...
  <div class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="lg:hidden">
          <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-3 text-gray-700"
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      <section class="h-screen flex items-center justify-center snap-start">
        <div class="text-center">
          <h1 class="text-5xl font-bold tracking-tight text-gray-800 sm:text-6xl">Musicalização Infantil a seu alcance!
          </h1>
          <p class="mt-8 text-lg font-bold text-green-600 sm:text-xl/8">Aprenda a transformar sons e brincadeiras em
            momentos mágicos de aprendizagem</p>
      ...
      <section class="flex items-center justify-center snap-start">
        <div class="text-center">
          ...
          <p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">Escolha o plano
            certo para você</p>
      ...
      <div
        ...
        <div v-for="(tier, tierIdx) in tiers" :key="tier.id"
          ...
          <h3 :id="tier.id"
            :class="[tier.featured ? 'text-indigo-400' : 'text-indigo-600', 'text-base/7 font-semibold']">{{ tier.name
            }}</h3>
